...
Mobile.verifyElementExist(findTestObject('Object Repository/Feature Dashboard Home/XCUIElementTypeStaticText - Asuransi'), 
    0)

Mobile.tap(findTestObject('Object Repository/Feature Dashboard Home/XCUIElementTypeStaticText - Asuransi'), 0)

if (Mobile.verifyElementNotExist(findTestObject('Object Repository/Asuransi Form/XCUIElementTypeOther - Asuransi'), 5, FailureHandling.OPTIONAL) == 
true) {
...
Mobile.verifyElementExist(findTestObject('Object Repository/Asuransi Form/XCUIElementTypeOther - Asuransi'), 0)
