...
Mobile.verifyElementExist(findTestObject('Lupa Pin Buat Pin/XCUIElementTypeStaticText - Buat PIN untuk mempermudah transaksi Anda. Usahakan PIN tidak sama dengan PIN ATM dan tidak mudah ditebak'), 
    0)
