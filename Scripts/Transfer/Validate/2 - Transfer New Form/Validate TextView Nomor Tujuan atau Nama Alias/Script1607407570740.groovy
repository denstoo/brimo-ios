...
String value = 'Nomor Tujuan atau Nama Alias'

Mobile.verifyElementExist(findTestObject('/1 - Custom Object/Required Value', [('value') : "${value}"]), 0, FailureHandling.STOP_ON_FAILURE)
