...
String enable = Mobile.getAttribute(findTestObject('1 - Custom Object/Required Type and Label', [('tipe') : "${tipe}", ('value') : "${value}"]), 'enabled',
	0)

'Button Lanjutkan Disable When No Input on Masukkan No. Rek'
