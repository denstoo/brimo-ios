...
Mobile.setText(findTestObject('Credit Nominal Close/XCUIElementTypeTextField - Nominal', [('text') : "${text}"]), amountCredit.toString(), 0)

Mobile.tap(findTestObject('Credit Nominal Close/XCUIElementTypeStaticText - Nominal Pembayaran'), 0)

Mobile.tap(findTestObject('Transfer Nominal Form/XCUIElementTypeImage - Pilih Rekening (1)'), 0)
...
if (decision.toString() == 'Save') {
	Mobile.tap(findTestObject('Transfer Nominal Form/XCUIElementTypeButton - Simpan ke Daftar'), 0)
