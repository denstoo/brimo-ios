...
Scroll.scrollListToElementWithText('Info Kurs', 0)

Mobile.tap(findTestObject('Feature Akun/XCUIElementTypeStaticText - Info Kurs'), 0)

Mobile.verifyElementExist(findTestObject('Info Kurs/XCUIElementTypeOther - Info Kurs'), 0)
