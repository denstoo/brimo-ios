...
Scroll.scrollListToElementWithText('Info Saham BRI', 0)

Mobile.tap(findTestObject('Feature Akun/XCUIElementTypeStaticText - Info Saham BRI'), 0)

Mobile.verifyElementExist(findTestObject('Info Saham/XCUIElementTypeOther - Info Saham'), 0)
