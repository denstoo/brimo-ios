...
Scroll.scrollListToElementWithText('Lokasi ATM BRI', 0)

Mobile.tap(findTestObject('Feature Akun/XCUIElementTypeStaticText - Lokasi ATM BRI'), 0)

Mobile.verifyElementExist(findTestObject('Lokasi ATM/XCUIElementTypeOther - Lokasi ATM'), 0)
