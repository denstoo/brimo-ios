...
Mobile.verifyElementExist(findTestObject('Telkom Nominal/XCUIElementTypeStaticText - Total Pembayaran'), 0)

int timeout = 1

Scroll.scrollListToElementWithText('Sumber Dana', timeout)

Mobile.delay(3)

Mobile.tap(findTestObject('Telkom Nominal/XCUIElementTypeImage - Pilih Rekening'), 0)
...
if (decision.toString() == 'Save') {
    Mobile.tap(findTestObject('Telkom Nominal/XCUIElementTypeButton - Simpan'), 0)

    Mobile.setText(findTestObject('Telkom Nominal/XCUIElementTypeTextField - Nama'), name.toString(), 0)

    Mobile.tap(findTestObject('Telkom Nominal/XCUIElementTypeStaticText - Sumber Dana'), 0)
}
