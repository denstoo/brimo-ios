...
if (condition.toString() == 'NEW') {
    CustomKeywords.'database.methods.executeUpdate'(('DELETE FROM tbl_history_payment_telkom WHERE username = "' + username.toString()) + 
        '"')
...
Mobile.verifyElementExist(findTestObject('Feature Dashboard Home/XCUIElementTypeStaticText - Telkom'), 0)

Mobile.tap(findTestObject('Feature Dashboard Home/XCUIElementTypeStaticText - Telkom'), 0)

if (Mobile.verifyElementNotExist(findTestObject('Telkom Form/XCUIElementTypeOther - Telkom'), 5, FailureHandling.OPTIONAL) ==
true) {
...
Mobile.verifyElementExist(findTestObject('Telkom Form/XCUIElementTypeOther - Telkom'), 0)
