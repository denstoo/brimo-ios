...
String value = 'Lihat Detail Tagihan'

Mobile.verifyElementExist(findTestObject('1 - Custom Object/Required Type and Value', [('tipe') : "$tipe", ('value') : "$value"]), 
    0, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('1 - Custom Object/Required Type and Value', [('tipe') : "$tipe", ('value') : "$value"]), 0, FailureHandling.STOP_ON_FAILURE)
