...
Mobile.verifyElementExist(findTestObject('Cicilan Nominal/XCUIElementTypeOther - Tagihan'), 0)

Scroll.scrollListToElementWithText('Sumber Dana', 0)

Mobile.verifyElementExist(findTestObject('Cicilan Nominal/XCUIElementTypeStaticText - Sumber Dana'), 0)

Mobile.tap(findTestObject('Cicilan Nominal/XCUIElementTypeImage - Pilih Rekening'), 0)
...
if (decision.toString() == 'Save') {
    Mobile.tap(findTestObject('Cicilan Nominal/XCUIElementTypeButton - Simpan'), 0)

    Mobile.setText(findTestObject('Cicilan Nominal/XCUIElementTypeTextField - Nama'), name.toString(), 0)

    Mobile.tap(findTestObject('Cicilan Nominal/XCUIElementTypeStaticText - Nominal Bayar'), 0)
}
...
Mobile.tap(findTestObject('Cicilan Nominal/XCUIElementTypeButton - Bayar'), 0)
