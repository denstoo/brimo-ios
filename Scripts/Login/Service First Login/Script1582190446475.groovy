...
CustomKeywords.'database.methods.executeUpdate'(('DELETE FROM tbl_brimo_activation WHERE username = "' + username.toString()) + 
    '"')

CustomKeywords.'database.methods.executeUpdate'(('DELETE FROM tbl_user_pin WHERE username = "' + username.toString()) + 
    '"')

CustomKeywords.'database.methods.executeUpdate'(('UPDATE tbl_user SET login_status = "0" WHERE username = "' + username.toString()) + 
    '"')
