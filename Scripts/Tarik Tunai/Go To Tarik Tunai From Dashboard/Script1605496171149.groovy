...
Mobile.verifyElementExist(findTestObject('Feature Dashboard Home/XCUIElementTypeStaticText - Tarik Tunai'), 0)

Mobile.tap(findTestObject('Feature Dashboard Home/XCUIElementTypeStaticText - Tarik Tunai'), 0)

if (Mobile.verifyElementNotExist(findTestObject('Tarik Tunai Form/XCUIElementTypeOther - Tarik Tunai'), 5, FailureHandling.OPTIONAL) == 
true) {
