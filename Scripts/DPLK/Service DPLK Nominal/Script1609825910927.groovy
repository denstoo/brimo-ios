...
Mobile.verifyElementExist(findTestObject('DPLK Nominal/XCUIElementTypeStaticText - Nominal Top Up'), 0)

Mobile.setText(findTestObject('Object Repository/DPLK Nominal/XCUIElementTypeTextField - Nominal'), amountDPLK.toString(), 
    0)

Mobile.tap(findTestObject('DPLK Nominal/XCUIElementTypeStaticText - Nominal Top Up'), 0)

Mobile.tap(findTestObject('Object Repository/DPLK Nominal/XCUIElementTypeImage - Pilih Rekening (1)'), 0)
...
if (decision.toString() == 'Save') {
    ...
    Mobile.tap(findTestObject('DPLK Nominal/XCUIElementTypeStaticText - Nomor Tujuan'), 0)
}
...
Mobile.tap(findTestObject('Object Repository/DPLK Nominal/XCUIElementTypeButton - Top Up'), 0)
