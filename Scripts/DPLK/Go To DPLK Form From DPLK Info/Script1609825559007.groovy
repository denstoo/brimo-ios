...
Mobile.tap(findTestObject('DPLK Info/XCUIElementTypeButton - Top Up DPLK'), 0)

Mobile.verifyElementExist(findTestObject('Object Repository/DPLK Form/XCUIElementTypeOther - DPLK'), 0)
