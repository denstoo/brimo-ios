...
Mobile.verifyElementExist(findTestObject('Pascabayar Confirm/XCUIElementTypeOther - Konfirmasi'), 0)
...
tax = Mobile.getText(findTestObject('Pascabayar Confirm/XCUIElementTypeStaticText - Admin Biaya'), 0)
...
Mobile.tap(findTestObject('Pascabayar Confirm/XCUIElementTypeButton - Bayar'), 0)
