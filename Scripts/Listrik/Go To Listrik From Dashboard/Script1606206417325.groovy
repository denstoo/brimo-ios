...
Mobile.verifyElementExist(findTestObject('Object Repository/Feature Dashboard Home/XCUIElementTypeStaticText - Listrik'), 
    0)

Mobile.tap(findTestObject('Object Repository/Feature Dashboard Home/XCUIElementTypeStaticText - Listrik'), 0)

if (Mobile.verifyElementNotExist(findTestObject('Object Repository/Listrik Form/XCUIElementTypeOther - Listrik'), 5, FailureHandling.OPTIONAL) == 
true) {
...
Mobile.verifyElementExist(findTestObject('Object Repository/Listrik Form/XCUIElementTypeOther - Listrik'), 0)
