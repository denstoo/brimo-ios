...
//TC_BRImo_app_LinkAja_ios_dompet_digital_203 User tidak memilih Dompet Digital dan input Nomor Tujuan
...
//TC_BRImo_app_LinkAja_ios_dompet_digital_205 User hanya input Nomor Tujuan
...
//Mobile.verifyElementExist(findTestObject('Wallet New Form/XCUIElementTypeOther - Dompet Digital'), 0)
Mobile.tap(findTestObject('Wallet New Form/XCUIElementTypeButton - BrimoIconArrowDownOutline'), 0)

//TC_BRImo_app_LinkAja_ios_dompet_digital_201 User dapat memilih Jenis Dompet Digital
//Mobile.delay(3)
Date today = new Date()
