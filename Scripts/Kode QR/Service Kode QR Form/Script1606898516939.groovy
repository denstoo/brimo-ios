...
Mobile.tap(findTestObject('Object Repository/Kode QR Form/XCUIElementTypeButton - Pilih Rekening'), 0)
...
Mobile.tap(findTestObject('Object Repository/Kode QR Form/XCUIElementTypeButton - Lanjutkan'), 0)
