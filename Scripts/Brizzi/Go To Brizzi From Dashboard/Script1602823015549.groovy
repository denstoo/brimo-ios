...
Mobile.verifyElementExist(findTestObject('Feature Dashboard Home/XCUIElementTypeStaticText - BRIZZI'), 0)

Mobile.tap(findTestObject('Feature Dashboard Home/XCUIElementTypeStaticText - BRIZZI'), 0)

if (Mobile.verifyElementNotExist(findTestObject('Brizzi Form/XCUIElementTypeOther - BRIZZI'), 5, FailureHandling.OPTIONAL) == 
true) {
...
while (Mobile.verifyElementExist(findTestObject('Feature Dashboard Home/XCUIElementTypeStaticText - BRIZZI'), 0, FailureHandling.OPTIONAL) == 
false) {
    Swipe.swipe(SwipeDirection.BOTTOM_TO_TOP)
}
