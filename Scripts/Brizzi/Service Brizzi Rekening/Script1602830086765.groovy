...
Mobile.verifyElementExist(findTestObject('Brizzi Rekening/XCUIElementTypeOther - BRIZZI'), 0)

Mobile.verifyElementExist(findTestObject('Brizzi Rekening/XCUIElementTypeStaticText - Sumber Dana'), 0)

Mobile.tap(findTestObject('Brizzi Rekening/XCUIElementTypeImage - Pilih Rekening'), 0)
...
Mobile.tap(findTestObject('Brizzi Rekening/XCUIElementTypeButton - Beli'), 0)
