...
if (Mobile.verifyElementExist(findTestObject('Briva Open Payment Service/XCUIElementTypeStaticText - Nomor Tujuan'), 0, 
...
switch (whatPayment.toString()) {
    case 'Open':
        ...
        String enable = Mobile.getAttribute(findTestObject('Briva Open Payment Service/XCUIElementTypeButton - Bayar'), 
            'enabled', 0)
    ...
    case 'Close':
        ...
        String enable = Mobile.getAttribute(findTestObject('Briva Close Payment Service/XCUIElementTypeButton - Bayar'), 
            'enabled', 0)
