...
Mobile.verifyElementExist(findTestObject('Briva New Form/XCUIElementTypeOther - BRIVA'), 0)

Mobile.setText(findTestObject('Briva New Form/XCUIElementTypeTextField - Nomor BRIVA'), brivaNumber.toString(), 0)
