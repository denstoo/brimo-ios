...
Mobile.verifyElementExist(findTestObject('Feature Dashboard Home/XCUIElementTypeStaticText - BRIVA'), 0)

Mobile.tap(findTestObject('Feature Dashboard Home/XCUIElementTypeStaticText - BRIVA'), 0)

if (Mobile.verifyElementNotExist(findTestObject('Briva Form/XCUIElementTypeOther - BRIVA'), 5, FailureHandling.OPTIONAL) == 
true) {
...
Mobile.verifyElementExist(findTestObject('Briva Form/XCUIElementTypeOther - BRIVA'), 0)
