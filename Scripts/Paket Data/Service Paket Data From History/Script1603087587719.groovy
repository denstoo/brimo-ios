...
Mobile.tap(findTestObject('Pulsa Form/XCUIElementTypeCell - History 1'), 0)

Mobile.tap(findTestObject('Pulsa Form/XCUIElementTypeStaticText - Paket Data'), 0)

//Mobile.tap(findTestObject('Pulsa Form/XCUIElementTypeStaticText - Pulsa'), 0)
//Swipe.swipe(SwipeDirection.BOTTOM_TO_TOP)

CustomKeywords.'operation.features.clickAmountPulsa'(amountPaketData.toString())
