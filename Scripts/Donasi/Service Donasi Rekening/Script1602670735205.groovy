...
Mobile.verifyElementExist(findTestObject('Donasi Rekening/XCUIElementTypeStaticText - Nomor Tujuan'), 0)

Mobile.tap(findTestObject('Donasi Rekening/XCUIElementTypeImage - Pilih Rekening'), 0)
...
Mobile.tap(findTestObject('Donasi Rekening/XCUIElementTypeButton - Bayar'), 0)
