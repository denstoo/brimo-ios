...
Mobile.verifyElementExist(findTestObject('Feature Dashboard Home/XCUIElementTypeStaticText - Donasi'), 0)

Mobile.tap(findTestObject('Feature Dashboard Home/XCUIElementTypeStaticText - Donasi'), 0)

if (Mobile.verifyElementNotExist(findTestObject('Donasi Form/XCUIElementTypeOther - Donasi'), 5, FailureHandling.OPTIONAL) == 
true) {
