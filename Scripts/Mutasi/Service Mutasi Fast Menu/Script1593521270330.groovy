...
Mobile.verifyElementExist(findTestObject('Fast Menu/XCUIElementTypeStaticText - Mutasi Masuk'), 0)

Mobile.verifyElementExist(findTestObject('Fast Menu/XCUIElementTypeCell - 1'), 0)
