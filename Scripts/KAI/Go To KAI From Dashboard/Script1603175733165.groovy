...
Mobile.verifyElementExist(findTestObject('Feature Dashboard Home/XCUIElementTypeStaticText - KAI'), 0)

Mobile.tap(findTestObject('Feature Dashboard Home/XCUIElementTypeStaticText - KAI'), 0)

if (Mobile.verifyElementNotExist(findTestObject('KAI Form/XCUIElementTypeOther - KAI'), 5, FailureHandling.OPTIONAL) == 
true) {
...
Mobile.verifyElementExist(findTestObject('KAI Form/XCUIElementTypeOther - KAI'), 0)
